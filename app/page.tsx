          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white">1. Connect Your Wallet</h3>
                <p className="mt-3 text-gray-500 dark:text-gray-400">
                  Sign in using your Web3 wallet to establish a secure digital identity.
                </p>
              </div>
